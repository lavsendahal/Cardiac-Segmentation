...
if __name__=='__main__':
    ...
    #pred_path = '/media/HDD1/lavsen/results/pred/pred_ed/best_model_ed_val_vis/'
    #atlas_path = '/media/HDD1/lavsen/results/uncertainty_map/softmax_epochs_300/deeplab_lv_ed/atlas_0_3/'    #Thresholded at 0.3 to create mask
    #gt_path = '/media/HDD1/lavsen/dataset/camus-dataset/all_images_gt_lv/'
    #fn_path = '/media/HDD1/lavsen/dataset/camus-dataset/ImageSets/Segmentation_lv_ED/val.txt'
    #save_path = '/media/HDD1/lavsen/results/csv_files/deeplab_lv_train_ed/atlas_and_pred_lv_train_ed_val.csv'
